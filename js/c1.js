document.addEventListener('DOMContentLoaded', () => {  
    const questions = [  
        {  
            question: "Qual das opções a seguir é a maneira correta de verificar se uma variável x é maior que 10 em C?",  
            options: ["if x > 10", "if (x > 10)", "if x > 10 then"],  
            answer: 1  
        },  
        {  
            question: "Qual a forma correta de declarar uma função em C?",  
            options: ["void minhaFuncao()", "def minhaFuncao()", "function minhaFuncao()"],  
            answer: 0  
        },  
        {  
            question: "Qual dos métodos abaixo usamos para receber algum dado do usuário através do CLI",  
            options: ["scanf()", "input()", "read()"],  
            answer: 0  
        },  
        {  
            question: "Qual dessas é uma biblioteca da linguagem C que permite trabalhar com strings?",  
            options: ["stdio.h", "string.h", "math.h"],  
            answer: 1  
        },  
        {  
            question: "Qual é o melhor atalho para incrementar a variável a=0 em C?",  
            options: ["a = a + 1;", "a += 1;", "a++;"],  
            answer: 2  
        }  
    ];  
